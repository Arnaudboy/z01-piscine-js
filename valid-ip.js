function findIP(data) {
    let arr =  data.match(/(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])+:?(\d+)?/g)
    let result = []
    arr.forEach(element => {element.match(/\.000/) != null ? element : result.push(element)})
    return result
}
...
//   '0.0.0.0',
// ]
// console.log(findIP(dataSet), $findIP)